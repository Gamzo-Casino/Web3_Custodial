      ...
      <div style={{ maxWidth: 1260, margin: "0 auto", padding: "1.5rem 1rem" }}>
        ...
        <div className="game-3col" style={{ alignItems: "flex-start" }}>
          ...
          <div>
            ...
            {/* Current bet info — shown below controls when active */}
            {isActive && gameState && (
              <div className="card" style={{ padding: "0.875rem", marginTop: "0.875rem" }}>
                <div style={{ fontSize: "0.7rem", fontWeight: 700, color: "#8888aa", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "0.625rem" }}>
                  Current Bet
                </div>
                <div style={{ fontSize: "0.8rem", color: "#f0f0ff" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", padding: "0.28rem 0", borderBottom: "1px solid #1a1a3544" }}>
                    <span style={{ color: "#8888aa" }}>Main stake</span>
                    <span style={{ fontWeight: 700 }}>{gameState.mainStakeGzo.toLocaleString()} GZO</span>
                  </div>
                  {gameState.splitStakeGzo != null && (
                    <div style={{ display: "flex", justifyContent: "space-between", padding: "0.28rem 0", borderBottom: "1px solid #1a1a3544" }}>
                      <span style={{ color: "#8888aa" }}>Split stake</span>
                      <span style={{ fontWeight: 700 }}>{gameState.splitStakeGzo.toLocaleString()} GZO</span>
                    </div>
                  )}
                  <div style={{ display: "flex", justifyContent: "space-between", paddingTop: "0.4rem", marginTop: "0.1rem" }}>
