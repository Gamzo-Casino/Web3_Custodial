...
export interface GZOTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface GZOToken extends BaseContract {
  connect(runner?: ContractRunner | null): GZOToken;
  waitForDeployment(): Promise<this>;

  interface: GZOTokenInterface;
