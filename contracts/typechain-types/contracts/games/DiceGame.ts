...
export declare namespace DiceGame {
  export type RoundStruct = {
    player: AddressLike;
    stake: BigNumberish;
    targetScaled: BigNumberish;
    roll: BigNumberish;
...
export interface DiceGameInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GAME_ID"
...
export interface DiceGame extends BaseContract {
  connect(runner?: ContractRunner | null): DiceGame;
  ...
  placeBet: TypedContractMethod<
    [stake: BigNumberish, targetScaled: BigNumberish],
    [string],
    "nonpayable"
  >;

  placeBetFor: TypedContractMethod<
    [player: AddressLike, stake: BigNumberish, targetScaled: BigNumberish],
    [string],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "RoundSettled(bytes32,address,uint256,bool,uint256,uint256)": TypedContractEvent<
      RoundSettledEvent.InputTuple,
      RoundSettledEvent.OutputTuple,
      RoundSettledEvent.OutputObject
    >;
