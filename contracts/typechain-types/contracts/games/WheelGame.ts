...
export declare namespace WheelGame {
  export type RoundStruct = {
    player: AddressLike;
    stake: BigNumberish;
    riskMode: BigNumberish;
    stopPosition: BigNumberish;
...
export interface WheelGameInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GAME_ID"
...
export interface WheelGame extends BaseContract {
  connect(runner?: ContractRunner | null): WheelGame;
  ...
  getConfig: TypedContractMethod<
    [riskMode: BigNumberish],
    [[bigint[], bigint[]] & { weights: bigint[]; mults: bigint[] }],
    "view"
  >;
  ...
  filters: {
    ...
    "RoundSettled(bytes32,address,uint256,uint8,uint256,bool,uint256,uint256)": TypedContractEvent<
      RoundSettledEvent.InputTuple,
      RoundSettledEvent.OutputTuple,
      RoundSettledEvent.OutputObject
    >;
