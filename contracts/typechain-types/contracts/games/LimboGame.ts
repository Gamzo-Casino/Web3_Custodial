...
export declare namespace LimboGame {
  export type RoundStruct = {
    player: AddressLike;
    stake: BigNumberish;
    targetBps: BigNumberish;
    generated: BigNumberish;
...
export interface LimboGameInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GAME_ID"
...
export interface LimboGame extends BaseContract {
  connect(runner?: ContractRunner | null): LimboGame;
  waitForDeployment(): Promise<this>;

  interface: LimboGameInterface;
  ...
  maxTargetBps: TypedContractMethod<[], [bigint], "view">;
  ...
  placeBet: TypedContractMethod<
    [stake: BigNumberish, targetBps: BigNumberish],
    [string],
    "nonpayable"
  >;
  ...
  setLimits: TypedContractMethod<
    [min_: BigNumberish, max_: BigNumberish, maxTarget_: BigNumberish],
    [void],
    "nonpayable"
  >;
