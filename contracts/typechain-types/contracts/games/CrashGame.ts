...
export declare namespace CrashGame {
  export type RoundStruct = {
    player: AddressLike;
    stake: BigNumberish;
    autoCashoutBps: BigNumberish;
    crashPoint: BigNumberish;
...
export interface CrashGameInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GAME_ID"
  ...
  encodeFunctionData(
    functionFragment: "maxAutoCashoutBps",
    values?: undefined
  ): string;
...
export interface CrashGame extends BaseContract {
  connect(runner?: ContractRunner | null): CrashGame;
  ...
  maxAutoCashoutBps: TypedContractMethod<[], [bigint], "view">;
  ...
  placeBet: TypedContractMethod<
    [stake: BigNumberish, autoCashoutBps: BigNumberish],
    [string],
    "nonpayable"
  >;
  ...
  setLimits: TypedContractMethod<
    [min_: BigNumberish, max_: BigNumberish, maxCashout_: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "maxAutoCashoutBps"
  ...
  filters: {
    "BetPlaced(bytes32,address,uint256,uint256)": TypedContractEvent<
      BetPlacedEvent.InputTuple,
      BetPlacedEvent.OutputTuple,
      BetPlacedEvent.OutputObject
    >;
    ...
    "RoundSettled(bytes32,address,uint256,uint256,bool,uint256,uint256)": TypedContractEvent<
      RoundSettledEvent.InputTuple,
      RoundSettledEvent.OutputTuple,
      RoundSettledEvent.OutputObject
    >;
