...
export interface RandomnessCoordinator extends BaseContract {
  ...
  callbackGas: TypedContractMethod<[], [bigint], "view">;
  ...
  ): TypedContractMethod<[gas_: BigNumberish], [void], "nonpayable">;
  getFunction(
