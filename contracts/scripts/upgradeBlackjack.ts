...
const BLACKJACK_PROXY = "0x370Af2cB87AFC8BDA70Daba1198c16e40C62CBC3";
...
async function main() {
  ...
  console.log("─────────────────────────────────────────────────────────");
  console.log("BlackjackGame v2 — direct implementation deploy");
  ...
  console.log("[1/3] Deploying new BlackjackGame implementation...");
  const Factory = await ethers.getContractFactory("BlackjackGame");
  ...
  console.log("\n─────────────────────────────────────────────────────────");
  console.log("✅ BlackjackGame v2 upgrade complete");
  console.log(`   Proxy:     ${BLACKJACK_PROXY}`);
  console.log(`   New impl:  ${newImplAddr}`);
  console.log(`   startRoundFor() + lockSplitFor() added — custodial bets enabled`);
  console.log("─────────────────────────────────────────────────────────");
}
